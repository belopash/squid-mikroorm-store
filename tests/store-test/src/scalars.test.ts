...
describe('scalars', function () {
    ...
    describe('String', function () {
        ...
        it('supports where conditions', async function () {
            let store = await createStore()
            expect(await store.find(Scalar, {string: 'baz foo bar'})).toMatchObject([{id: '8', string: 'baz foo bar'}])
        })
    })
    ...
    describe('BigInt', function () {
        ...
        it('supports where conditions', async function () {
            ...
            expect({
                ...
                not_in: await store.find(Scalar, {bigint: {$nin: [1000000000000000000000000000000000000n, 5n]}}),
            }).toMatchObject({
                eq: [{id: '4'}],
                not_eq: [{id: '3'}, {id: '5'}],
                gt: [{id: '4'}],
    ...
    describe('BigDecimal', function () {
        it('outputs correctly', async function () {
            ...
            expect(await store.find(Scalar, {id: {$in: ['20', '21', '22']}})).toMatchObject([
                {
                    id: '20',
                    bigdecimal: BigDecimal('2e-35'),
                },
                {
                    id: '21',
                    bigdecimal: BigDecimal('1e-35'),
                },
                {
                    id: '22',
